...
(function (global, factory) {
      ...
      _createClass(Draggable, [{
        ...
        value: function _init(el) {
          ...
          if (isDef(handles.center)) {
            ...
            cHandle.css({
              left: "".concat(el.getAttribute('data-sjx-cx'), "px"),
              top: "".concat(el.getAttribute('data-sjx-cy'), "px")
            });
          }
        ...
        value: function _apply() {
          ...
          el.setAttribute('data-sjx-cy', centerY); // if (isUndef(cached)) return;
          // const $el = helper(el);
          // const { dx, dy } = cached;
      ...
      _createClass(DraggableSVG, [{
        ...
        value: function _init(el) {
          ...
          var _el$getBBox = el.getBBox(),
              boxWidth = _el$getBBox.width,
              boxHeight = _el$getBBox.height,
              cx = _el$getBBox.x,
              cy = _el$getBBox.y;

          var elCTM = getTransformToElement(el, container);
          var box = createSVGElement('rect');
          var attrs = [['width', boxWidth], ['height', boxHeight], ['x', cx], ['y', cy], ['fill', THEME_COLOR], ['fill-opacity', 0.1], ['stroke', THEME_COLOR], ['stroke-dasharray', '3 3'], ['vector-effect', 'non-scaling-stroke'], ['transform', matrixToString(elCTM)]];
        ...
        value: function _pointToControls(_ref5) {
          var x = _ref5.x,
              y = _ref5.y;
          var boxCTM = this.storage.transform.boxCTM;
        ...
        value: function _apply(actionName) {
          ...
          var _ref6 = isDef(handles.center) ? pointTo(boxCTM, handles.center.cx.baseVal.value, handles.center.cy.baseVal.value) : pointTo(matrix, elX + elW / 2, elY + elH / 2),
              centerX = _ref6.x,
              centerY = _ref6.y;
        ...
        value: function _processResize(dx, dy) {
          ...
          var left = storage.left,
              top = storage.top,
              boxWidth = storage.boxWidth,
              boxHeight = storage.boxHeight,
              transform = storage.transform,
              revX = storage.revX,
              revY = storage.revY,
              doW = storage.doW,
          ...
          var scaleX = newWidth / boxWidth,
              scaleY = newHeight / boxHeight; // setup scale matrix
          ...
          if (scalable) {
            ...
            var boxScaleMatrix = trMatrix.multiply(scMatrix).multiply(trMatrix.inverse());
            var boxMatrix = rectMatrix.multiply(boxScaleMatrix);
            box.setAttribute('transform', matrixToString(boxMatrix));
        ...
        value: function _getState(_ref7) {
          ...
          var _box$getBBox2 = box.getBBox(),
              boxWidth = _box$getBBox2.width,
              boxHeight = _box$getBBox2.height,
              boxLeft = _box$getBBox2.x,
              boxTop = _box$getBBox2.y;
          ...
          var boxScaleX = boxLeft + boxWidth * (doH ? 0.5 : revX ? 1 : 0),
          ...
          var boxCenterX = boxLeft + boxWidth / 2,
          ...
          var _ref8 = isDef(cHandle) ? pointTo(parentMatrix.inverse(), bcx, bcy) : pointTo(elMatrix, elX + elW / 2, elY + elH / 2),
              elcx = _ref8.x,
        ...
        value: function resetCenterPoint() {
          ...
          var _box$getBBox3 = box.getBBox(),
              boxWidth = _box$getBBox3.width,
              boxHeight = _box$getBBox3.height,
              boxLeft = _box$getBBox3.x,
              boxTop = _box$getBBox3.y;

          var matrix = getTransformToElement(box, box.parentNode);

          var _pointTo5 = pointTo(matrix, boxLeft + boxWidth / 2, boxTop + boxHeight / 2),
              cx = _pointTo5.x,
              cy = _pointTo5.y;
        ...
        value: function fitControlsToSize() {
          ...
          Object.entries(boxAttrs).forEach(function (_ref9) {
    ...
    var createHandler$1 = function createHandler(left, top, color, key) {
      ...
      Object.entries(attrs).forEach(function (_ref12) {
    ...
    var updateBoxBoundaries = function updateBoxBoundaries(box, data) {
      var x = data.x,
          y = data.y,
          width = data.width,
          height = data.height;
    ...
    var applyResize = function applyResize(element, data) {
      ...
      var boxW = bBox.width,
          boxH = bBox.height;
      var attrs = []; //  const ctm = getTransformToElement(element, container);

      var containerCTM = container.getScreenCTM() || createSVGMatrix();
      var elementMatrix = element.getScreenCTM().multiply(cached.resultMatrix);
        ...
        case 'rect':
          {
            var _element$__data__3 = element.__data__,
                ...
                _x2 = _element$__data__3.x,
                _y2 = _element$__data__3.y;

            var _pointTo8 = pointTo(localCTM, _x2, _y2),
                _resX4 = _pointTo8.x,
                _resY4 = _pointTo8.y;
        ...
        case 'ellipse':
          {
            var _element$__data__4 = element.__data__,
                ...
                _cx2 = _element$__data__4.cx,
                _cy2 = _element$__data__4.cy;

            var _pointTo9 = pointTo(localCTM, _cx2, _cy2),
                cx1 = _pointTo9.x,
                cy1 = _pointTo9.y;
